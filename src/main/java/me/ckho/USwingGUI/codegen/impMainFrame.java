...
public class impMainFrame extends javax.swing.JFrame {
    ...
    protected String[] timeFilters = {"Last 1 Hour", "Last 6 Hours", "Last 12 Hours", "Last 1 Day", "Last 3 Days", "Last Week"};
    ...
    protected javax.swing.JButton TaskDetailOverviewButton;
    ...
    private void initComponents() {
        ...
        TaskDetailOverviewButton = new javax.swing.JButton();
        ...
        TaskDetailOverviewButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/ico/20pix/overview.png"))); // NOI18N
        TaskDetailOverviewButton.setToolTipText("Task details overview");
        TaskDetailOverviewButton.setFocusable(false);
        TaskDetailOverviewButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        TaskDetailOverviewButton.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        TaskDetailOverviewButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TaskDetailOverviewButtonActionPerformed(evt);
            }
        });
        MainToolBar.add(TaskDetailOverviewButton);
        ...
        FetchLogBriefButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                FetchLogBriefButtonActionPerformed(evt);
            }
        });
    ...
    private void FetchLogBriefButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FetchLogBriefButtonActionPerformed
        impFetchLogBriefButtonActionPerformed(evt);
    }//GEN-LAST:event_FetchLogBriefButtonActionPerformed

    private void TaskDetailOverviewButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TaskDetailOverviewButtonActionPerformed
        impTaskDetailOverviewButtonActionPerformed(evt);
    }//GEN-LAST:event_TaskDetailOverviewButtonActionPerformed
    ...
    protected void updateRowColor() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            for (int j = 0; j < tableRows; j++) {
                tb.setDefaultRenderer(String.class, new TableRowsRenderer());
            }
        }
    }
